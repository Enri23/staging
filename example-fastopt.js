...
$c_Lexample_ScalaJSExample$.prototype.main__Lorg_scalajs_dom_raw_HTMLCanvasElement__V = (function(canvas) {
  ...
  var elem = new $c_Lexample_Point().init___I__I(0, 0);
  var p = new $c_sr_ObjectRef().init___O(elem);
  var corners = $as_sc_Seq($m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lexample_Point().init___I__I(255, 255), new $c_Lexample_Point().init___I__I(0, 255), new $c_Lexample_Point().init___I__I(128, 0)])));
  $g["setInterval"]((function(ctx$1, count$1, p$1, corners$1) {
    return (function() {
      $m_Lexample_ScalaJSExample$().example$ScalaJSExample$$run$1__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__sr_IntRef__sr_ObjectRef__sc_Seq__V(ctx$1, count$1, p$1, corners$1)
    })
...
$c_Lexample_ScalaJSExample$.prototype.example$ScalaJSExample$$run$1__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__sr_IntRef__sr_ObjectRef__sc_Seq__V = (function(ctx$1, count$1, p$1, corners$1) {
  var i = 0;
  var count = 0;
  while ((i !== 10)) {
    var v1 = i;
    if ((((count$1.elem$1 % 1000) | 0) === 0)) {
      $m_Lexample_ScalaJSExample$().example$ScalaJSExample$$clear$1__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(ctx$1)
    };
    count$1.elem$1 = ((1 + count$1.elem$1) | 0);
    var jsx$1 = $as_Lexample_Point(p$1.elem$1);
    var this$4 = $m_s_util_Random$();
    p$1.elem$1 = jsx$1.$$plus__Lexample_Point__Lexample_Point($as_Lexample_Point(corners$1.apply__I__O(this$4.self$1.nextInt__I__I(3)))).$$div__I__Lexample_Point(2);
    var height = (512.0 / ((255 + $as_Lexample_Point(p$1.elem$1).y$1) | 0));
    var r = $doubleToInt(($as_Lexample_Point(p$1.elem$1).x$1 * height));
    var g = $doubleToInt((((255 - $as_Lexample_Point(p$1.elem$1).x$1) | 0) * height));
    var b = $as_Lexample_Point(p$1.elem$1).y$1;
    ...
    ctx$1["fillStyle"] = s;
    ctx$1["fillRect"]($as_Lexample_Point(p$1.elem$1).x$1, $as_Lexample_Point(p$1.elem$1).y$1, 1.0, 1.0);
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  }
});
$c_Lexample_ScalaJSExample$.prototype.example$ScalaJSExample$$clear$1__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(ctx$1) {
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Lexample_Point() {
  $c_O.call(this);
  this.x$1 = 0;
  this.y$1 = 0
}
$c_Lexample_Point.prototype = new $h_O();
$c_Lexample_Point.prototype["constructor"] = $c_Lexample_Point;
/** @constructor */
function $h_Lexample_Point() {
  /*<skip>*/
}
$h_Lexample_Point.prototype = $c_Lexample_Point.prototype;
$c_Lexample_Point.prototype.productPrefix__T = (function() {
  return "Point"
});
$c_Lexample_Point.prototype.productArity__I = (function() {
  return 2
});
$c_Lexample_Point.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lexample_Point(x$1)) {
    var Point$1 = $as_Lexample_Point(x$1);
    return ((this.x$1 === Point$1.x$1) && (this.y$1 === Point$1.y$1))
  } else {
    return false
  }
});
$c_Lexample_Point.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.x$1;
      break
...
$c_Lexample_Point.prototype.$$plus__Lexample_Point__Lexample_Point = (function(p) {
  return new $c_Lexample_Point().init___I__I(((this.x$1 + p.x$1) | 0), ((this.y$1 + p.y$1) | 0))
});
$c_Lexample_Point.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lexample_Point.prototype.init___I__I = (function(x, y) {
  this.x$1 = x;
  this.y$1 = y;
  return this
});
$c_Lexample_Point.prototype.$$div__I__Lexample_Point = (function(d) {
  return new $c_Lexample_Point().init___I__I(((this.x$1 / d) | 0), ((this.y$1 / d) | 0))
});
$c_Lexample_Point.prototype.hashCode__I = (function() {
  var acc = (-889275714);
...
$c_Lexample_Point.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lexample_Point(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lexample_Point)))
}
function $as_Lexample_Point(obj) {
  return (($is_Lexample_Point(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "example.Point"))
}
function $isArrayOf_Lexample_Point(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lexample_Point)))
}
function $asArrayOf_Lexample_Point(obj, depth) {
  return (($isArrayOf_Lexample_Point(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lexample.Point;", depth))
}
var $d_Lexample_Point = new $TypeData().initClass({
  Lexample_Point: 0
}, false, "example.Point", {
  Lexample_Point: 1,
  O: 1,
...
$c_Lexample_Point.prototype.$classData = $d_Lexample_Point;
/** @constructor */
